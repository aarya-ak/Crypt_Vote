...
<div class="">
<h2><center><b>ELECTION STATUS</b></center></h2>
<?php

	echo "<div class='col-sm-2' style='float:right;margin-bottom:10px;'><form action='form.php' method='post'><input type='submit' name='view' value='Add New' class='form-control btn-primary'></form></div>";
